...
#define STUTTOMETER_VERSION_PATCH 5
#define STUTTOMETER_VERSION_STRING "0.5.5"
#define STUTTOMETER_VERSION_QUAD 0,5,5,0
#define STUTTOMETER_VERSION_QUAD_STRING "0.5.5.0"

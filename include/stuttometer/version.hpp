...
#define STUTTOMETER_VERSION_PATCH 6
#define STUTTOMETER_VERSION_STRING "0.5.6"
#define STUTTOMETER_VERSION_QUAD 0,5,6,0
#define STUTTOMETER_VERSION_QUAD_STRING "0.5.6.0"

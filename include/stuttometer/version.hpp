...
#define STUTTOMETER_VERSION_PATCH 1
#define STUTTOMETER_VERSION_STRING "0.5.1"
#define STUTTOMETER_VERSION_QUAD 0,5,1,0
#define STUTTOMETER_VERSION_QUAD_STRING "0.5.1.0"

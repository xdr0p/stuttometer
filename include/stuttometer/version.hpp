...
#define STUTTOMETER_VERSION_PATCH 2
#define STUTTOMETER_VERSION_STRING "0.5.2"
#define STUTTOMETER_VERSION_QUAD 0,5,2,0
#define STUTTOMETER_VERSION_QUAD_STRING "0.5.2.0"

...
#define STUTTOMETER_VERSION_PATCH 4
#define STUTTOMETER_VERSION_STRING "0.5.4"
#define STUTTOMETER_VERSION_QUAD 0,5,4,0
#define STUTTOMETER_VERSION_QUAD_STRING "0.5.4.0"

...
static void apply_edit_centered_padding(HWND hwnd, HFONT hFont = nullptr) {
    RECT rc_client;
    ...
    switch (uMsg) {
        ...
        case WM_COMMAND: {
            ...
            if (wmId == IDC_SET_BTN_RESET) {
                ...
                g_settings_config.osd_duration_ms = 3500;
...
// Subclassed Edit Control Procedure: Keeps text centered with dynamic font-metric vertical padding
static LRESULT CALLBACK EditCenteredSubclassProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam, UINT_PTR uIdSubclass, DWORD_PTR /*dwRefData*/) {
    switch (uMsg) {
        case WM_NCDESTROY:
